...
from notarized_notes_dvm import NotarizedNotesDVM, BitcoinDaemonConfig
...
async def main():
    ...
    async with NotarizedNotesDVM(relays, private_key, db_path, bitcoin_daemon_conf) as _dvm:
